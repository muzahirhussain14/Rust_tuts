/*
    ...
    Notes:
        - Run 'cargo test --bin filename' to check your program
*/
...
fn part_1() -> bool {
    // We are checking whether or not this particular user has an access level. The "admin"
    // user does have an access level.
...
fn part_2() -> Option<Access> {
    ...
    // "Root" is equivalent to Access::Admin, but it is not listed in the maybe_access method.
